...
- What dataset is that
- Means covariances of the classes
...
pcrossover_values <- seq(0.1, 1.0, by = 0.1)
pmutation_values <- seq(0.1, 1.0, by = 0.1)
...
sigma_values <- seq(0.1, 1.0, by = 0.1)
popSize_values <- c(20, 50, 100)
